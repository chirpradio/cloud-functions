...
describe("images", () => {
  ...
  test("are not searched for when a track is deleted", async () => {
    await processPlaylistTrack({ data: deletedBuffer });    
